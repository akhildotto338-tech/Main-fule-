(function () {
  ...
  const CONFIG = {
    r: "https://raw.githubusercontent.com/akhildotto338-tech/Ft-client-main-text-/refs/heads/main/Main-text",
    t: "https://raw.githubusercontent.com/akhildotto338-tech/Teliggram-channel-/refs/heads/main/My%20channel",
  ...
  const VALID_KEYS = [
    "ft953259", // Tetap dipertahankan biar ga crash kalau ada cache lama
  ];
  ...
  (async function () {
    ...
    const titleName    = "FT CLIENT";
    const telegramLink = "https://t.me/+Qjrl3DUTGVU2MWZl"; // Mengikuti variabel asal t.me/ramachanel sesuai script asli
    ...
    creditLink.innerText = "FT CLIENT Official";
    creditLink.href      = "https://t.me/+Qjrl3DUTGVU2MWZl";
    ...
    function runRedirect(countdownSeconds) {
      ...
      setTimeout(async () => {
        let hasUpdate = false;
        try {
          const updateRes  = await fetch("https://ftf-scrip-loader.arafathosann355.workers.dev/");
